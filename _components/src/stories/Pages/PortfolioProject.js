  ...
  <main>
    <article className="bg-white">
      <div
        ...
        style={{
          backgroundImage: 'url(http://mrmrs.github.io/photos/001.jpg)'
        }}
      />
      <div className="ph4 ph5-m ph6-l">
        ...
        <div className="cf mw8 center">
          <div className="fl w-33 w-50-m w-33-l pr2 pr2-l">
            <div
              ...
              style={{
                background: 'url(http://mrmrs.github.io/photos/002.jpg)'
              }}
            />
          </div>
          <div className="fl w-33 w-50-m w-33-l ph3 pr0-m ph3-l">
            <div
              className="pv6 cover bg-center"
              style={{
                backgroundImage: 'url(http://mrmrs.github.io/photos/003.jpg)'
              }}
            />
          </div>
          <div className="fl w-33 w-100-m w-33-l pl2 pl0-m pl2-l mt4-m">
            <div
              className="pv6 cover bg-center"
              style={{
                backgroundImage: 'url(http://mrmrs.github.io/photos/004.jpg)'
              }}
            />
          </div>
        </div>
        ...
        <div className="measure f4 f3-ns center mv5 black-70">
          <p className="lh-copy measure f3 black-70 baskerville">
            There's an unspoken shadow over the stories about that town house on
            Essex Drive. James Jordan remodeled the basement for his son. Did
            all the work himself, because he'd never let Michael pay for
