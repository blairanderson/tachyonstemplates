...
<main>
    ...
    <div className="ph4 ph5-m ph6-l">
      ...
      <div className="cf mw8 center">
        <div className='fl w-33 w-50-m w-33-l pr2 pr2-l'>
          <div className="pv6 cover bg-center" style="background: url(http://mrmrs.github.io/photos/002.jpg);"></div>
        </div>
        <div className='fl w-33 w-50-m w-33-l ph3 pr0-m ph3-l'>
          <div className="pv6 cover bg-center" style="background-image: url(http://mrmrs.github.io/photos/003.jpg);"></div>
        </div>
        <div className='fl w-33 w-100-m w-33-l pl2 pl0-m pl2-l mt4-m'>
          <div className="pv6 cover bg-center" style="background-image: url(http://mrmrs.github.io/photos/004.jpg);"></div>
        </div>
      </div>
      ...
      <div className="measure f4 f3-ns center mv5 black-70">
        ...
        <div className="aspect-ratio aspect-ratio--16x9 mv5">
          <iframe src="https://www.youtube.com/embed/LAr6oAKieHk" className="aspect-ratio--object" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
        </div>
      </div>
    </div>
  </article>
  <section className="cf mt5 pv5 bt b--black-05 ph6-l">
    ...
    <a href="#0" className="fl w-third w-25-ns border-box overflow-hidden ba bw2 white" title="">
      <div className="grow cover bg-center pv5 pv6-l" style="background-image:url(https://s3-us-west-2.amazonaws.com/prnt/hw-080411-cargo_960.jpg);"></div>
    </a>
    <a href="#0" className="fl w-third w-25-ns border-box overflow-hidden  ba bw2 white" title="">
      <div className="grow cover bg-top pv5 pv6-l" style="background-image:url(https://s3-us-west-2.amazonaws.com/prnt/hwspringtour-cargo_960-1.jpg);"></div>
    </a>
    <a href="#0" className="fl w-third w-25-ns border-box overflow-hidden ba bw2 white" title="">
      <div className="grow cover bg-top pv5 pv6-l" style="background-image:url(https://s3-us-west-2.amazonaws.com/prnt/cc010611.s_960.jpg);"></div>
    </a>
    <a href="#0" className="fl w-100 w-25-ns border-box overflow-hidden ba bw2 white" title="">
      <div className="grow cover bg-top pv5 pv6-l" style="background-image:url(https://s3-us-west-2.amazonaws.com/prnt/adam-stern-031209_960-2.jpg);"></div>
    </a>
    <a href="#0" className="fl w-50 border-box overflow-hidden ba bw2 white" title="">
      <div className="grow cover bg-center pv5 pv7-l" style="background-image:url(https://s3-us-west-2.amazonaws.com/prnt/zh170311.4.cargo_960.jpg);"></div>
    </a>
    <a href="#0" className="fl w-50 border-box overflow-hidden ba bw2 white" title="">
      <div className="grow cover bg-center pv5 pv7-l" style="background-image:url(https://s3-us-west-2.amazonaws.com/prnt/hw090911_960.jpg);"></div>
    </a>
  </section>
</main>
