    ...
    <section className="fl w-100">
      ...
      <div className="fl w-100 w-50-m w-25-l pa3-m pa4-l">
        <p className="f6 lh-copy measure">
          ...
          touch) alone. It flows from something rarely appreciated today: good
          taste. The book designer strives for perfection; yet every perfect
          thing lives somewhere in the neighborhood of dullness and is
          frequently mistaken for it by the insensitive. In a time that hungers
          for tangible novelties, dull perfection holds no advertising value at
          all.
        </p>
      </div>
      <div className="fl w-100 w-50-m w-25-l pa3-m pa4-l">
        <p className="f6 lh-copy measure">
          ...
          small and empty peculiarities, frequently damaging, that masquerade as
          innovations.
        </p>
      </div>
      <div className="fl w-100 w-50-m w-25-l pa3-m pa4-l">
        <p className="f6 lh-copy measure">
          ...
          develop a sense for a perfect piece of work. Unfortunately, most seem
          content with a middling performance. Careful spacing of words and the
          correct spacing of capital letters appear to be unknown or unimportant
          to some typesetters, yet for him who investigates, the correct rules
    ...
    <section className="fl w-100">
      ...
      <div className="fl w-100 w-50-m w-25-l pv3 pa3-m pa4-l">
        <div className="aspect-ratio aspect-ratio--3x4">
          <span
            style={{
              backgroundImage: 'url(http://mrmrs.github.io/images/0045.jpg)'
            }}
            className="cover bg-center aspect-ratio--object"
          />
        </div>
      ...
      <div className="fl w-100 w-50-m w-25-l pv3 pa3-m pa4-l">
        <div className="aspect-ratio aspect-ratio--3x4">
          <span
            style={{
              backgroundImage: 'url(http://mrmrs.github.io/images/0051.jpg)'
            }}
            className="cover bg-center aspect-ratio--object"
          />
        </div>
      ...
      <div className="fl w-100 w-50-m w-25-l pv3 pa3-m pa4-l">
        <div className="aspect-ratio aspect-ratio--3x4">
          <span
            style={{
              backgroundImage: 'url(http://mrmrs.github.io/images/0038.jpg)'
            }}
            className="cover bg-center aspect-ratio--object"
          />
        </div>
