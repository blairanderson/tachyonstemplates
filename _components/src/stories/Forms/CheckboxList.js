    ...
    <fieldset id="favorite_movies" className="bn">
      ...
      <div className="flex items-center mb2">
        <input
          ...
          value="homealone"
        />
        <label for="homealone" className="lh-copy">
          Home Alone
        </label>
      </div>
    </fieldset>
